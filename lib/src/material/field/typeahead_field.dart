...
class TypeAheadField<T> extends StatefulWidget {
  ...
  TypeAheadField({
    ...
    super.key,
        ...
        assert((suggestionsCallback == null && suggestionsStreamCallback != null) ||
            (suggestionsCallback != null && suggestionsStreamCallback == null));
  ...
  void _initOverlayEntry() {
    this._suggestionsBox!.overlayEntry = OverlayEntry(builder: (context) {
      ...
      final suggestionsList = SuggestionsList<T>(
          ...
          suggestionsStreamCallback: widget.suggestionsStreamCallback,
